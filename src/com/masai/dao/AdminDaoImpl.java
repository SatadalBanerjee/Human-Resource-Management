...
//                                    UPDATING ADMIN PROFILE
	...
	public String updateProfile(Admin admin) throws AdminException{
		...
		try(Connection conn = GetConnection.connection()) {
			...
			PreparedStatement ps = conn.prepareStatement("UPDATE admin SET name = ?,password = ?,email = ? WHERE password =? AND email = ? ");
...
//                            ADDING NEW EMPLOYEE
	...
	public String addEmployee(Employee emp) {
		...
		try(Connection conn = GetConnection.connection()) {
			...
			PreparedStatement ps = conn.prepareStatement("INSERT INTO employee(empName,empSalary,empRole,empPassword,empEmail,did) values(?,?,?,?,?,?)" );
...
//			SELECTING EMPLOYEE ID FROM EMPLOYEE TABLE
...
//			INSERTING EMPLOYEE ID AND EMPLOYEE NAME IN LEAVE TABLE
...
//	              UPDATING THE DEPARTMENTS ALREADY PRESENT
...
//								TRANSFERING EMPLOYEE TO DEPARTMENT
...
//								CHECKING DEPARTMENT TO BE TRANSFERED
